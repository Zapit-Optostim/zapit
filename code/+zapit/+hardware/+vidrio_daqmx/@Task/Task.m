classdef Task < zapit.hardware.vidrio_daqmx.private.DAQmxClass
    ...
    methods
        ...
        function obj = Task(varargin)
            ...
            taskmap = zapit.hardware.vidrio_daqmx.Task.getTaskMap();
        ...
        function chanObjs = createAIVoltageChan(obj,deviceNames,chanIDs,chanNames,minVal,maxVal,units,customScaleName,terminalConfig)
            ...
            chanObjs = zapit.hardware.vidrio_daqmx.AIChan('DAQmxCreateAIVoltageChan',obj,deviceNames,chanIDs,chanNames,...
        ...
        function chanObjs = createAOVoltageChan(obj,deviceNames,chanIDs,chanNames,minVal,maxVal,units,customScaleName)
            ...
            %Create the channel(s)!
            chanObjs = zapit.hardware.vidrio_daqmx.AOChan('DAQmxCreateAOVoltageChan',obj,deviceNames,chanIDs,chanNames,...
        ...
        function chanObj = createDOChan(obj,deviceNames,chanIDs,chanNames,lineGrouping)
            ...
            %Create the channel!
            chanObj = zapit.hardware.vidrio_daqmx.DOChan('DAQmxCreateDOChan',obj,deviceNames,chanIDs,chanNames,obj.encodePropVal(lineGrouping));
        end
        ...
        function chanObj = createDIChan(obj,deviceNames,chanIDs,chanNames,lineGrouping)
            ...
            %Create the channel(s)!
            chanObj = zapit.hardware.vidrio_daqmx.DIChan('DAQmxCreateDIChan',obj,deviceNames,chanIDs,chanNames,obj.encodePropVal(lineGrouping));
        ...
        function chanObjs = createCOPulseChanFreq(obj, deviceNames, chanIDs, chanNames, freq, dutyCycle, initialDelay, idleState, units)
            ...
            %Create the channel!
            chanObjs = zapit.hardware.vidrio_daqmx.COChan('DAQmxCreateCOPulseChanFreq',obj,deviceNames,chanIDs,chanNames,...
        ...
        function chanObjs = createCOPulseChanTicks(obj, deviceNames, chanIDs, chanNames, sourceTerminal, lowTicks, highTicks, initialDelay, idleState)
            ...
            %Create the channel!
            chanObjs = zapit.hardware.vidrio_daqmx.COChan('DAQmxCreateCOPulseChanTicks',obj,deviceNames,chanIDs,chanNames,...
        ...
        function chanObjs = createCOPulseChanTime(obj, deviceNames, chanIDs, chanNames, lowTime, highTime, initialDelay, idleState, units)
            ...
            %Create the channel!
            chanObjs = zapit.hardware.vidrio_daqmx.COChan('DAQmxCreateCOPulseChanTime',obj,deviceNames,chanIDs,chanNames,...
        ...
        function chanObjs = createCICountEdgesChan(obj, deviceNames, chanIDs, chanNames, countDirection, edge, initialCount)
            ...
            %Create the channel!
            chanObjs = zapit.hardware.vidrio_daqmx.CIChan('DAQmxCreateCICountEdgesChan',obj,deviceNames,chanIDs,chanNames,...
        ...
        function chanObjs = createCIPeriodChan(obj, deviceNames, chanIDs, chanNames, edge, minVal, maxVal, units, measMethod, measTime, divisor, customScaleName)
            ...
            %Create the channel!
            chanObjs = zapit.hardware.vidrio_daqmx.CIChan('DAQmxCreateCIPeriodChan',obj,deviceNames,chanIDs,chanNames,...
        ...
        function chanObjs = createCITwoEdgeSepChan(obj, deviceNames, chanIDs, chanNames, firstEdge, secondEdge, minVal, maxVal, units, customScaleName)
            ...
            %Create the channel!
            chanObjs = zapit.hardware.vidrio_daqmx.CIChan('DAQmxCreateCITwoEdgeSepChan',obj,deviceNames,chanIDs,chanNames,...
    ...
    methods (Static, Hidden)
        ...
        function tObjs = getAllTasks()
            map = zapit.hardware.vidrio_daqmx.Task.getTaskMap();
            tObjs = map.values';
            tObjs = [tObjs{:}]';
        end
        function clearAllTasks()
           t = zapit.hardware.vidrio_daqmx.Task.getAllTasks();
           delete(t);
        end
    end
    ...
    methods (Access=private)
        ...
        function registerXXXEventPriv(obj,eventName,eventRegistrationMethod)
            ...
            zapit.hardware.vidrio_daqmx.idioms.pauseTight(.01); %This seems to be necessary to gurantee that registration takes effect before subsequent start command (if it happens right away)
        end
