classdef PDEPProp < zapit.hardware.vidrio_daqmx.DClass
    ...
    methods (Access=protected)
        ...
        function pdepPropGetDisallow(obj, src, evnt) %#ok<INUSD>
            propName = src.Name;
            zapit.hardware.vidrio_daqmx.idioms.dispError('Specified property (%s) cannot be accessed for objects of class %s\n', propName, class(obj));
        ...
        function pdepPropSetDisallow(obj, src, evnt) %#ok<INUSD>
            propName = src.Name;
            zapit.hardware.vidrio_daqmx.idioms.dispError('Specified property (%s) cannot be set for objects of class %s\n', propName, class(obj));
    ...
    methods 
		...
		% Find the latest (right-zapit.hardware.vidrio_daqmx) handle object aH in the set (a1,a2,a3).
		...
		% Perform the right-zapit.hardware.vidrio_daqmx assignment, then assign back up the chain
		%    ... v1(i2).a2 = v2; H(i1).pdepSetWithErr('a1',v1). Since H is the
		%    right-zapit.hardware.vidrio_daqmx handle obj, there are no other handle objs and hence no
    ...
    methods (Hidden)
        ...
        function pdepHandleErr(obj,src,ME)
            ...
            switch obj.pdepErrState
                ...
                case 'none'
                    zapit.hardware.vidrio_daqmx.idioms.warn('%s',estr);
        ...
        function pdepPropHandleGetHidden(obj, src, evnt)
            ...
            if ~obj.pdepPropGlobalLock && ...
                ...
                try
                    ...
                    %zapit.hardware.vidrio_daqmx.idioms.dispError('WARNING(%s): Unable to access property ''%s'' because of following error:\n\t%s\n%s\n', class(obj), propName, ME.message, getLastErrorStack(ME));%TO091210A
        ...
        function pdepPropHandleSetHidden(obj, src, evnt)
            ...
            if ~obj.pdepPropGlobalLock && ...
                ...
                if ~tfErr
                    notify(obj,'pdepSetSuccess',zapit.hardware.vidrio_daqmx.PDEPPropEventData(propName));
                end
