classdef System < zapit.hardware.vidrio_daqmx.private.DAQmxClass
    ...
    methods 
        function obj = System(varargin)
            ...
            obj = zapit.hardware.vidrio_daqmx.System.getHandle();
        end
    end
    ...
    methods
        ...
        function val = get.tasks(obj)
            val = zapit.hardware.vidrio_daqmx.Task.getAllTasks();
        end
        
        function val = get.taskMap(obj)
            val = zapit.hardware.vidrio_daqmx.Task.getTaskMap();
        end
    ...
    methods (Static,Hidden)       
        function obj = getHandle()            
            ...
            if isempty(localObj) || ~isvalid(localObj)
                localObj = zapit.hardware.vidrio_daqmx.System('singleton');
            end
            obj = localObj;
        end        
    end    
