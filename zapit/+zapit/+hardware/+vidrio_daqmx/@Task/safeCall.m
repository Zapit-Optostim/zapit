...
if errCode
    [err,errString] = calllib(zapit.hardware.vidrio_daqmx.System.driverLib,'DAQmxGetErrorString',errCode,dummyString,length(dummyString));
    zapit.hardware.vidrio_daqmx.idioms.dispError('DAQmx ERROR: %s\n', errString);
    ok = false; %
else
    ok = true; %No error
end
