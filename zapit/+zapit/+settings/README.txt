...
What is zapit.settings.default_settings?
...
The function zapit.settings.checkSettingsAreValid uses the function handles from second output arg of zapit.settings.default_settings
to test settings. The functions themselves are from static methods of the 
