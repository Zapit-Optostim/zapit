classdef view < matlab.apps.AppBase
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            app.SetexperimentpathButton.Position = [7 47 124 23];
            ...
            app.ExportwaveformsButton.Position = [7 73 122 23];
            ...
            app.ExperimentPathTextArea.Position = [7 2 213 44];
            ...
            app.ClearpathButton.Position = [136 47 81 23];
